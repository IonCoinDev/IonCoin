...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "IonCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"192.99.43.83", "192.99.43.83"},
    {"192.99.43.9", "192.99.43.9"},
    {"192.99.43.82", "192.99.43.82"},
    {"192.99.42.226", "192.99.42.226"},
    {"192.99.43.81", "192.99.43.81"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. IonCoin is probably already running."), addrBind.ToString().c_str());
        else

...
int64 nChainStartTime = 1400978243;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight <= 4320)
	{
		nSubsidy = 695 * COIN;	// 695 coins per block for the first three days.
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The secrets of life are hidden behind the word cliche";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0xa142336bcc03e40d3784c20229b3f26da3e33e31370d344fee85f879f1fc2049"));

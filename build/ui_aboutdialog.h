...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About IonCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>IonCoin</b> version", 0));
...
"Copyright \302\251 2014 IonCoin Developers\n"
"", 0));
